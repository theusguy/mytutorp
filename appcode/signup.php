...
<?php
  ...
  if (isset($_POST['register_btn'])) {
    ...
    $c = mysqli_real_escape_string($conn, $_POST["school"]);
    $d = mysqli_real_escape_string($conn, $_POST["Referrer_name"]);
    ...
    $result = mysqli_query($conn, $user_check_query);
        ...
        $password = md5($e);
            $query = "INSERT INTO tbl_users (name,email,school,refer_name,password,created_date)
            VALUES('$a', '$b', '$c', '$d','$password','$f')";
            ...
            <form id="" action="" name="form" onsubmit="return checkForm(this);"  class="default-form" method="post">
              ...
              <div class="form-group">
                <select class="form-control" name="school" >
                    <option    selected="selected " required><?php if(isset($c)){ echo $c; }else {echo "Choose Option"; } ?></option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="Referrer_name" class="form-control" value="<?php if(isset($d)): echo $d; endif; ?>" placeholder="Referrer name" required>
